...
use Instride\Bundle\PimcoreElementManagerBundle\DuplicateIndex\Similarity\ContainerSimilarityCheckerFactory;
...
class AddSimilarityCheckerPass implements CompilerPassInterface
{
    ...
    public function process(ContainerBuilder $container): void
    {
        ...
        $dataTransformers = [];
        $services = $container->findTaggedServiceIds('pimcore_element_manager.similarity_checker', true);
